...
| [claudecode.nvim](https://github.com/coder/claudecode.nvim) | `ai/claudecode.lua` | IDE integration for the [Claude Code](https://docs.anthropic.com/en/docs/claude-code) CLI agent — same protocol as the official VS Code/JetBrains extensions. See [AI in Neovim](ai.md) for setup, keymaps, and how to point it at a non-Anthropic backend. |
